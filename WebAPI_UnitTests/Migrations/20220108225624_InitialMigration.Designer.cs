...
namespace WebAPI_UnitTests.Migrations
{
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebAPI_UnitTests.Data.Entities.CatalogItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("WebAPI_UnitTests.Data.Enums.CatalogBrand", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("WebAPI_UnitTests.Data.Enums.CatalogType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("WebAPI_UnitTests.Data.Entities.CatalogItem", b =>
                {
                    b.HasOne("WebAPI_UnitTests.Data.Enums.CatalogBrand", "CatalogBrand")
                        .WithMany()
                        .HasForeignKey("CatalogBrandId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("WebAPI_UnitTests.Data.Enums.CatalogType", "CatalogType")
                        .WithMany()
